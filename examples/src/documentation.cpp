...
int main(){
	std::cout << "\033[32mWELCOME IN THE RATIO LIB !\033[0m" << std::endl << std::endl;
	...
	std::cout << "\033[36mClassic operators : \033[0m" << std::endl;
	std::cout << "• +" << std::endl;
	std::cout << "• -" << std::endl;
	std::cout << "• *" << std::endl;
	std::cout << "• /" << std::endl;
	...
	std::cout << "\033[36mComparison operators :\033[0m" << std::endl;
	std::cout << "• =" << std::endl;
	std::cout << "• ==" << std::endl;
	std::cout << "• <=" << std::endl;
	std::cout << "• >=" << std::endl;
	...
	std::cout << "\033[36mOthers arithmetic operators :\033[0m" << std::endl;
	...
	std::cout << "\033[36mSpecific numbers\033[0m" << std::endl;
	...
	std::cout << "\033[36mConstructors :\033[0m" << std::endl;
	...
	std::cout << "\033[36mDisplay ratios : \033[0m" << std::endl;
	std::cout << "Finally, you can display your ratios with two ways : "<< std::endl; 
	...
	std::cout << "\033[32mIT'S YOUR MOVE !\033[0m" << std::endl;
